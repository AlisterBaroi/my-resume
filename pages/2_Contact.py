...
st.set_page_config(
    page_title="Alister Baroi", page_icon=":page_facing_up:", layout="centered", initial_sidebar_state="expanded", 
    # menu_items=None
)
...
def main():
  ...
  with form_sec[0]:
     ...
     components.html("""<script src='https://platform.linkedin.com/badges/js/profile.js' type='text/javascript'></script>
     <div class="badge-base LI-profile-badge" data-locale="en_US" data-size="small" data-theme="light" data-type="VERTICAL" data-vanity="alisterbaroi" data-version="v1">
  ...
  with form_sec[1]:
    with st.form(key="contact"):
      ...
      contact_form_col[0].text_input("Your Email Address", placeholder="e.g. johndoe@example.com")

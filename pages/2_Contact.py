...
st.set_page_config(
    page_title="Alister Animesh Baroi - Contact", page_icon=":page_facing_up:", layout="centered", initial_sidebar_state="expanded", 
    # menu_items=None
)
...
def main():
  ...
  st.title("Contact —")
  st.markdown(
      """This is the :green[***Contact***] page, where you can contact me via the :green[contact form] below, or reaching out to me on my :blue[LinkedIn] profile.  
